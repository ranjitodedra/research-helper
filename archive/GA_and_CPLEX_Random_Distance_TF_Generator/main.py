...
if __name__ == "__main__":
    ...
    node_types = {
        "D": "depot",
        **{str(i): "intersection" for i in range(1, 9)},      # intersections 1–8
        **{str(i): "intersection" for i in range(19, 21)},    # intersections 19–20
        "BSS1": "bss",
        "BSS2": "bss",
        **{f"C{i}": "customer" for i in range(1, 9)}         # customers C1–C8
    }
