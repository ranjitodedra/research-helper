...
# Extract identifier from filenames like "800c_400bss_2000total_High_Traffic.txt", "800c_400bss_2000total_mid.txt", etc.
...
def process_all(base_dir: Path):
    ...
    for file_path in sorted(base_dir.glob("*.txt")):
        ...
        file_id = match.group(1)  # Extract traffic level (High_Traffic, mid, Low, etc.)
